...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://localhost:5174", "http://localhost:5175", "http://localhost:5176", "http://localhost:5177", "http://www.aitalent.net.cn", "http://aitalent.net.cn", "https://www.aitalent.net.cn", "https://aitalent.net.cn"],
